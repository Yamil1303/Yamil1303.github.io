function toggle() {
    ...
    /*var toggleclass = document.getElementById("primaryNav").classList;
    if (toggleclass != "hide") {
        document.getElementById("summary").style.top="380px";
    } else {document.getElementById("summary").style.top="140px";}*/
}
